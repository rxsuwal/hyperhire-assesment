...
function App() {
  return (
    <div className="com_bg-white p_detail">

      <header className="com_pg_header">
        <a href='/'><img src='/assets/icon/left_arrow.png' alt='' /></a>
        <strong className='title'>자유톡</strong>
        <a role="button">
          <img src="/assets/icon/bell.png" alt="" />
        </a>
      </header>

      <section className='p_content'>
        <div className='p_content_header'>
          <div className='p_content_header-left'>
            <a href="#">
